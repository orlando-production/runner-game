...
import {requestPostData, requestGetData, requestPutData} from '../../services/RequestData';
...
const ProfilePage = () => {
    ...
    const fetchDataSave = ({ first_name, second_name, email, phone, login, password, display_name}) => {
            ...
            <div className={styles['profile-container']}>
                ...
                <Box className={classNames(styles['profile-box'], styles['profile-box_settings'])}>
                    ...
                    <Box component="form" onSubmit={handleSubmit} noValidate sx={{mt: 1}}
                        ...
                        />
                        <div
                            className={isError ? styles['warning-message'] : styles['invisible-message']}>{warningText}</div>
                        <Button
                            type="submit"
                            fullWidth
                            variant="contained"
