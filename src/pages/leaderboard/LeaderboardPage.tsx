...
const LeaderboardPage = () => {
    ...
    const plugs = [
        {nick: 'Volodya777', avatar: '', position: '10', scores: '1000'},
        {nick: 'Volodya777', avatar: '', position: '10', scores: '1000'},
        {nick: 'Volodya777', avatar: '', position: '10', scores: '1000'}];
    ...
    return (
        <div className={styles['leaderboard-page']}>
            <div className={styles['leaderboard-container']}>
                <Typography component="h1" variant="h5" className={styles['leaderboard-title']}
                            mb={5}>Leaderbord</Typography>
                <Box className={styles['leaderboard-content']}>
                    ...
                    {data.map((field, index) => (
                        <div key={index} className={styles['leaderboard-field']}>
